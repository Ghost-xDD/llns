...
const DevelopersContent = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        'We provide a resolver API for developers to resolve LLNS domains. The API is open source and available on GitHub.',
    },
  ];

  return (
    <>
      <div className="flex flex-col md:flex-row text-white p-10">
        ...
        <div className="flex-grow space-y-4">
          {features.map((feature, index) => (
            ...
            >
              ...
              <p className="w-full md:w-3/4 text-xl md:mt-5 mt-2 text-gray-400">
                {feature.description}
              </p>
            </div>
          ))}
